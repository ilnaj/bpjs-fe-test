...
<div>
    ...
    <b-row>
        <div v-if="value.length==0" class="add-butt" @click="addEducation"> + add education</div>
        <div v-else>
          <b-col md="12">
                <div class="accordion-menu">
                  <ul v-for="(edu,idx) in value" :key="idx" style="margin-top:5px">
                      <li>
                          ...
                          <p tyle="width:100%">
                            <b-row>
                              <b-col><input-text :label="'School'" :value="edu.school" @input="(e)=>edu.school = e"></input-text></b-col>
                              <b-col><input-text :label="'Degree'" :value="edu.degree"  @input="(e)=>edu.degree = e"></input-text></b-col>
                            </b-row>
                            <b-row>
                              <b-col>
                                  <b-row>
                            ...
                            <b-row>
                              <b-col>
                                ...
                                <rich-text :value="edu.description"  @input="(e)=>edu.description = e"></rich-text>
                              </b-col> 
                            </b-row>
                          </p>
                      </li>
          ...
          <div @click="addEducation" class="add-butt"> + add one more education</div>
        </div>
    </b-row>
</div>
</template>
